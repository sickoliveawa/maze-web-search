"""
_sweep_runner_2026_07_04.py — Full sweep for paper §5

Matrix (sko 07-04 spec):
  mask      : 8 = chebyshev-{1,2,3,4} + manhattan-{1,2,3,4}
  maxFam    : 4 = {1, 2, 4, 8}
  seed      : 4 = {111, 222, 333, 444}
  gridW×H   : 40 × 60
  popSize   : 200
  generations: 500

Total runs: 8 × 4 × 4 = 128
Estimated wall time: ~6.5 min/run × 128 ≈ 13.5 hours

Saves to: E:\\doro\\maze-web\\sweep_2026_07_04\\results.ndjson
"""
...
SWEEP_DIR = r"E:\doro\maze-web\sweep_2026_07_04"
