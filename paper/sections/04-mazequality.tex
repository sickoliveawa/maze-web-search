...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=0pt]
  ...
  \item \textbf{$M_c$ 最大连通占比}. 截断到 0.8 即满分, 允许最多 20\% 的内部墙体孔洞残留。
...
权重的设计动机: $M_c$ 取 0.40 (走廊结构的最强信号), $M_{\text{bnd}}$ 取 0.30 (外圈抑制在 $0.7591$ 引诱吸引子分析后新增), 其余拓扑侧各 0.10; $M_t$ 取 0.50, 是经验上多样性侧的最弱项, 提高权重让 ES 可见梯度。
